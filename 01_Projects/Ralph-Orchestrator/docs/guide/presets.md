...
**Hats:** Planner → Builder → Deployer → Verifier
**Best for:** Safe deployments, release management
...
```bash
ralph init --preset merge-loop
```

**Hats:** Merger
**Best for:** Parallel loop management
...
```bash
ralph init --preset hatless-baseline
```

**Hats:** None (Core Loop Only)
**Best for:** Baseline testing, verification
