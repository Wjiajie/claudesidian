...
[Read on Omnivore](https://omnivore.app/me/dark-side-191fd1699f5)
[Read Original](https://www.0x08.org/docs/hacker-howto.html)

## Highlights

> <mark class="omni omni-blue">作为一个黑客，你必须培养起这些精神。但是仅仅有精神并不能使你成为黑客，也不能使你成为运动健将或摇滚明星。成为一名黑客还需要智力，实践，奉献精神和辛勤工作。</mark> [⤴️](https://omnivore.app/me/dark-side-191fd1699f5#03eb16a9-58fc-4c98-acbe-cd065fef6732) 


## content
## 如何成为黑客

Eric Steven Raymond, [Thyrsus Enterprises](http://catb.org/~esr/), < [esr@thyrsus.com](mailto:esr@thyrsus.com) \>

Copyright © 2001 Eric S. Raymond

翻译：柯非, < [zer4tul@gmail.com](mailto:zer4tul@gmail.com) \>

这篇译文基于2020.01.03更新的[原文](http://catb.org/~esr/faqs/hacker-howto.html)修订版1.52。

如果对译文有任何意见或者建议，**请[发Issue](https://github.com/zer4tul/hacker-howto/issues/new)，或直接[发Pull Request](https://github.com/zer4tul/hacker-howto/compare/)给我。**
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,svYUDMmPRsab2qIQC4pqs9SDsgvr81yYT6nw2PHJKSE0/http://www.catb.org/~esr/faqs/glider.png) 

## 为何会有这篇文档

身为[新黑客词典（The Jargon File）](http://www.catb.org/jargon)和许多其他广为人知的同类文章的作者，我常收到热心的网络新人的电子邮件，问及（大意上是）“如何成为一名魔法师似的黑客？”。1996年的时候我注意到这个重要的问题并没有相关的FAQ或文档页面，所以我写了一份。许多黑客认为这篇文章是权威的，我觉得它应该是吧。此外，我不会寻求在这个话题上的独立著作权，如果你不喜欢在这里读到的内容，自己写一篇吧。

如果你是在离线阅读本文，可以在<http://catb.org/~esr/faqs/hacker-howto.html>找到本文的最新版本。（译注：本文的最新中文版可以在[这里](https://github.com/zer4tul/hacker-howto)找到）

注意：本文的末尾有一系列[常见问题](#常见问题)。请在向我发邮件询问关于本文的任何问题前 **再三阅读**。

目前本文有许多语言的翻译版：[阿拉伯语](http://www.slashproc.net/doc/howto-ar.html)，[白俄罗斯语](http://moneyaisle.com/worldwide/how-to-become-a-hacker-be), [中文](http://www.0x08.org/docs/hacker-howto.html)，[捷克语](http://jjk.kybli.net/projekty/jakse-stat-hackerem.html)，[丹麦语](http://www.olemichaelsen.dk/hacker-howto.html)，[荷兰语](http://www.knudde.be/index.php?page%5Fname=hacker%5Fhowto)，[爱沙尼亚语](http://www.kakupesa.net/hacker/)，[德语](http://www.linuxtaskforce.de/hacker-howto-ger.html)，[希腊语](http://users.otenet.gr/~indy90/hacker-howto-gr/)，[意大利语](http://www.victorfleur.com/documents/hacker.html)，[希伯来语](http://he.wikisource.org/wiki/%D7%90%D7%99%D7%9A%5F%D7%9C%D7%94%D7%99%D7%95%D7%AA%5F%D7%94%D7%90%D7%A7%D7%A8)，[挪威语](http://stian.atlantiscrew.net/doc/hacker-howto.html), [波斯语](http://ashiyane.org/forums/showthread.php?t=20570)，[巴西葡萄牙语](http://jvdm.sdf1.org/pt/raquer-howto/)，[罗马尼亚语](http://garaj.xhost.ro/hacker-howto/hacker-howto.ro.htm)，[西班牙语](http://www.sindominio.net/biblioweb/telematica/hacker-como.html)，[土耳其语](http://www.belgeler.org/howto/hacker-howto/hacker-howto.html)，[瑞典语](http://www1.tripnet.se/~mly/open/faqs/hacker-howto.se.html)。请注意，由于本文不定期更新，这些翻译版可能存在不同程度的过时。

本文里九宫格中的5个黑点的装饰图被称作glider。这是一个使很多黑客多年痴迷的被称作[康威生命游戏（LIFE）](http://dmoz.org/Computers/Artificial%5FLife/Cellular%5FAutomata/)中，具有令人惊奇特性的简单图案。我认为它是很好的黑客精神徽章 —— 抽象，初见的时候感觉有点神秘，通过它复杂的逻辑可以通向整个世界。如果你想了解更多关于glider的信息，请看[这里](http://www.catb.org/~esr/hacker-emblem/)。

如果你觉得这篇文章有价值，请在[Patreon](http://patreon.com/esr)或者[SubscribeStar](https://www.subscribestar.com/esr)上给我一点赞助。也请考虑通过[Loadsharers](http://www.catb.org/esr/loadsharers/)赞助其他为你提供了有价值代码的黑客。小额的赞助也能够聚小流成江海，使为你提供帮助的人从繁重的劳动中解放出来，创造更多的价值。

![](https://proxy-prod.omnivore-image-cache.app/0x0,svYUDMmPRsab2qIQC4pqs9SDsgvr81yYT6nw2PHJKSE0/http://www.catb.org/~esr/faqs/glider.png) 

## 什么是黑客

[新黑客词典（Jargon File）](http://www.catb.org/jargon)中有数个“黑客”的定义，主要形容”技术专才”或”有志解决问题及超越极限之人”。要成为黑客，有两个要点。
...
如果你想成为一个黑客，请继续读下去。如果你只想做一个Cracker，请到[alt.2600](news:alt.2600)讨论组，并做好当你发现自己不如想象中聪颖的时候进5到10次监狱的准备。关于Cracker我就说这么多。
...
我必须再提一下[How To Learn Hacking](http://catb.org/~esr/faqs/hacking-howto.html)，这是一些简单的说明，但是学起来并不容易。
...
Rick Moen写了一篇很棒的关于[如何运营一个Linux用户组](http://linuxmafia.com/faq/Linux%5FPR/newlug.html)的文章。
...
Q: [如何证明我已经是一名黑客了？](#hacker%5Falready)  
Q: [你能教我做黑客吗？](#teach%5Fhack)  
Q: [我该如何开始？](#getting%5Fstarted)  
Q: [我该什么时候开始学？现在会不会太迟了？](#when%5Fstart)  
Q: [学会黑客之道要多长时间？](#how%5Flong)  
Q: [Visual Basic是一门好的入门语言吗？](#closed%5Flang)  
Q: [你能教我“黑”掉一个网站，或者教我怎么黑它吗？](#I%5Fwant%5Fto%5Fcrack%5Fand%5FIm%5Fan%5Fidiot)  
Q: [我怎么样才能得到别人帐号的密码？](#passwords)  
Q: [我如何入侵/查看/监视别人的email？](#crackmail)  
Q: [我如何才能盗取IRC的频道管理员权限？](#crackop)  
Q: [我被人入侵了。你能帮我避免以后再被攻击吗？](#anti%5Fcrack)  
Q: [我的Windows软件出现问题了。你能帮我吗？](#windows%5Fgrief)  
Q: [我在哪里可以找到能与之交流的真正的黑客？](#real%5Fhackers)  
Q: [你能推荐一些有关黑客的好书吗？](#books)  
Q: [成为一名黑客我需要擅长数学吗？](https://www.0x08.org/docs/mathematics)  
Q: [我该从哪种语言开始学？](#language%5Ffirst)  
Q: [我需要什么样的机器配置？](#hardware)  
Q: [我想做贡献。你能帮我挑选一个问题来处理吗？](#started2)  
Q: [我得因此憎恨和反对Microsoft吗？](#MS%5Fhater)  
Q: [但开放源代码软件不会使程序员丢饭碗吗？](#no%5Fliving)  
...
Q: 我如何入侵/查看/监视别人的email？

A: 这是破坏行为。从我面前消失，混蛋。

Q: 我如何才能盗取IRC的频道管理员权限？

A: 这是破坏行为。去死，蠢货。

Q: 我被人入侵了。你能帮我避免以后再被攻击吗？
...
Q: 我的Windows软件出现问题了。你能帮我吗？

A: 是的。进入DOS模式，然后输入“format c:”。你遇到的问题将在几分钟内消失。

Q: 我在哪里可以找到能与之交流的真正的黑客？

A: 最佳办法是在你附近找一个Unix或Linux的用户组，参加他们的聚会（你可以在ibiblio的[LDP](http://www.tldp.org/)站点找到一些指向用户组的链接）。
...
A: 看起来不太可能——目前为止，开放源代码软件产业似乎创造了更多的就业机会而不是减少就业机会。如果写一个程序比起不写来是纯经济收益的话，那么在写完后，程序员应该得到报酬不管程序是否是开放源代码。并且，无论写出多么“免费自由”的软件，都存在更多对新的，定制的软件的需求。我有这方面更多的论述，放在[Open Source](http://www.opensource.org/)网站资料中。
