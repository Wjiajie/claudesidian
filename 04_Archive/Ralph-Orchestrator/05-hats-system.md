...
关键原则：**事件本质是路由信号，而非数据传输通道**。

正如厨房喊单不包含菜谱详情，事件仅传递"发生了什么"，而非"所有细节"。
...
这就是帽子系统的魔力：**通过强制分离职责，让每个阶段都能获得最专业的处理**。
...
就像一个优秀的演员，不会同时扮演所有角色，他们会在每个场景中全身心投入当前的角色。换一顶帽子，就是换一个人。

---

*上一篇：[质量门卫：用"反压"代替"处方"](04-backpressure.md)*

*下一篇：[神经系统：事件与路由](06-events-routing.md)*
